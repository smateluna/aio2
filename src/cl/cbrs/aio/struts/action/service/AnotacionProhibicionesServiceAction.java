...
public class AnotacionProhibicionesServiceAction extends CbrsAbstractAction {

	private static final Logger logger = Logger.getLogger(AnotacionProhibicionesServiceAction.class);
...
//		}
		...
		if(StringUtils.isBlank(usuarioCreador)){
			...
			cl.cbrs.inscripciondigitalph.vo.AnotacionVO anotacionVO = new cl.cbrs.inscripciondigitalph.vo.AnotacionVO();
			...
			cl.cbrs.inscripciondigitalph.vo.InscripcionDigitalVO digitalVO = new cl.cbrs.inscripciondigitalph.vo.InscripcionDigitalVO();
...
//			anotacionVO.setFechaRepertorio(fechaRepertorio);
	...
	public void removeAnotacion(ActionMapping mapping, ActionForm form,
		...
		if(StringUtils.isBlank(usuarioEliminador)){
			...
			try {				
				cl.cbrs.inscripciondigitalph.vo.AnotacionVO anotacionVO = digitalDelegate.obtenerAnotacion(idAnotacion);
