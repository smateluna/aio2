...
public class ADAuthenticator 
{
  ...
  public ADAuthenticator() {
    this.domain = "CBRS";
    this.ldapHost = "ldap://192.168.100.170:389";
    this.searchBase = "cn=Users,dc=cbrs,dc=local"; // YOUR SEARCH BASE IN LDAP
  }
  ...
  public ADAuthenticator(String domain, String host, String dn)
  {
    ...
    public Map<String, Object> authenticate(String user, String pass) {
        ...
        String searchFilter = "(&(objectClass=Users)(sAMAccountName=" + user + "))";
