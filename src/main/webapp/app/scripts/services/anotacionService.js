...
app.factory('AnotacionService', function ($http, $q) {

  // Public API here
  return {
    addAnotacion: function (idInscripcion, acto, texto, caratula, repertorio, version, fechaRepertorio) {

      var paramsObj = 'metodo=addAnotacion&idInscripcion='+idInscripcion+'&acto='+encodeURIComponent(acto)+'&texto='+encodeURIComponent(texto)+'&caratula='+caratula+'&repertorio='+repertorio+'&version='+version+'&fechaRepertorio='+fechaRepertorio ;

      var deferred = $q.defer();

      $http({
        method: 'POST',
        url: '../do/service/anotacion',
        dataType: 'json',
        data: paramsObj,
