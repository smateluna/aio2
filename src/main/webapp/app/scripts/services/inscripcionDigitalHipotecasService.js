...
app.factory('inscripcionDigitalHipotecasService', function ($http, $q) {
  ...
  return {
    getInscripcionParaDigital: function (foja, numero, ano, bis) {
      ...
      $http({
        method: 'GET',
        url: '../do/service/inscripcionDigitalHipotecas',
        params: paramsObj
      }).
    ...
    getTiposAnotacion: function () {
      ...
      return deferred.promise;
        ...
        return deferred.promise;
      },getAnotacionParaRevision: function (fojaini, fojafin, ano) {
        var paramsObj = {metodo: 'getAnotacionParaRevision', fojaini: fojaini, fojafin: fojafin, ano: ano};
