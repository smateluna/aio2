...
app.controller('SolicitudesProhibicionesCtrl', function ($rootScope, $scope, $timeout, $location, solicitudesProhibicionesModel, $filter, $modal, $modalStack, inscripcionDigitalService, solicitudService) {
  //modelos
  $scope.tab = solicitudesProhibicionesModel.getTab();
  $scope.busquedaTitulo = solicitudesProhibicionesModel.getBusquedaTitulo();
  ...
  $scope.busquedaRut = solicitudesProhibicionesModel.getBusquedaRut();
  ...
  $scope.$watchCollection('busquedaRut', function(){
    ...
    if($.Rut.validar($scope.busquedaRut.rut)){
    	solicitudesProhibicionesModel.setBusquedaRut($scope.busquedaRut);
    }
  });

  $scope.busquedaMis = solicitudesProhibicionesModel.getBusquedaMis();

  //$scope.$watchCollection('busquedaMis', function(){
  //solicitudesProhibicionesModel.setBusquedaMis($scope.busquedaMis);
  //});

  $scope.states = solicitudesProhibicionesModel.getStates();

  //$scope.$watchCollection('states', function(){
  //solicitudesProhibicionesModel.setStates($scope.states);
  //});
  ...
  $scope.activateParent = function(id){
    ...
    solicitudesProhibicionesModel.setTab($scope.tab);
